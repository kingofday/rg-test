...
import { SurfaceWaterUsageVolumeTypeEnum } from "models/surfaceWater";
...
const WaterAmount = ({ readOnly }: IStepContent) => {
  ...
  return (
    <Col xs={24} sm={24}>
      <Form.List name="surfaceWaterUsageVolume">
        {(fields, { add, remove }) => (
          <>
            {!readOnly && (
              <Form.Item>
            ...
            {fields.map(({ key, name, ...restField }, idx) => (
              <Row gutter={[10, 10]}>
                ...
                <Col xs={20} sm={4}>
                  <Form.Item
                    name={[name, "surfaceWaterUsageVolumeType"]}
                  ...
                  >
                    <Select
                      ...
                      options={utils.convrtEnumToOptions(
                        SurfaceWaterUsageVolumeTypeEnum
                      )}
                      disabled={readOnly}
                    />
                  </Form.Item>
